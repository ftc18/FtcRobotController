...
import com.qualcomm.robotcore.util.ElapsedTime;
 ...
 /**   private static final String VUFORIA_KEY =
    ...
    private static final float mmTargetHeight   = 3 * mmPerInch;          // the height of the center of the target image above the floor
